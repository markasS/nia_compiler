 ...
 */
public class IfTACGenerator extends TACGenerator {
    @Override
    public void generateCode(SyntaxTreeItem syntaxTreeItem, int indent) {
        ...
        if (endItem == null || VariablesTable.getLabelsTable().containsKey(endItem.getOperand1().toString())) {
            endItem = generateLabel();
        ...
        TACodeItem returnFromRecursionSTItem = endItem;
        ...
        endItem = returnFromRecursionSTItem;
       ...
       // TACodeItemsList.getList().addLast(returnFromRecursionSTItem);
       // VariablesTable.getLabelsTable().put(returnFromRecursionSTItem.getOperand1().toString(),TACodeItemsList.getList().size()-1 );
    }
    ...
    public String getRuleName() {
        return TACGeneratorsMap.IF_NAME;
    }
}
